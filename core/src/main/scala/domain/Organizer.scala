...
trait Organizer extends Serializable {
    ...
    /** Property to set the organizer's ID.
      *
      * @param ID organizer's ID
      */
    def idOrganizer_=(ID: Int): Unit
...
/**
  ...
  */
case class OrganizerImpl(override var idOrganizer: Int, override val name: String, override val surname: String, override val email: String) extends Organizer {
